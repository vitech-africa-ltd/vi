        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-500/40 text-emerald-400 text-xs font-bold uppercase tracking-wider">
              ...
              <span>Études de Cas &amp; Systèmes en Production</span>
            </div>

            <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-white">
              Découvrez Nos Réalisations Majeures &amp;{' '}
            ...
            <p className="text-sm sm:text-base text-slate-300 leading-relaxed">
              Des applications financières à fort volume de transactions aux plateformes logistiques et médicales, découvrez comment nos ingénieurs ont résolu des défis techniques complexes.
            </p>
            ...
            <div className="pt-4 flex flex-wrap gap-3">
              ...
              >
                <span>Chiffrer un projet similaire</span>
              ...
              >
                ...
                <span>Discuter avec notre Direction Technique</span>
              </button>
            </div>
          </div>
        </div>
